...
public:
    ...
    // 如果不加virtual，则是静态联编，函数地址在编译阶段就能确定，运行"DoSpeak(cat)"结果是"动物在说话"
    virtual void speak()
    {
        cout << "动物在说话" << endl;
    }
...
void test02()
{
    cout << "sizeof Animal = " << sizeof(Animal) << endl;   // 8字节，Linux系统中一个指针的大小
}
...
![多态案例三-电脑组装案例.png](../../assets/多态案例三-电脑组装案例.png)
